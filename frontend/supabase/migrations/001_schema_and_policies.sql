-- ==========================================================
-- MALLU MART INVENTORY & REVENUE MANAGEMENT
-- Supabase Schema, Functions, RLS Policies & Realtime Setup
-- ==========================================================
...
begin
  ...
  -- Phase 2: Generate invoice number (e.g. MM-1049)
  ...
  for v_item in select * from jsonb_array_elements(p_items) loop
    ...
    -- Check for stock alerts and insert notifications
